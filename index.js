...
appelm.setAttribute("onclick", 'new Noir({"id":' + apps[app].id + ', "title": "' + apps[app].title + '", "type": "' + apps[app].type + '", "' + apps[app].type + '": "' + apps[app][apps[app].type] + '", "width": 800, "height": 600, "theme": "dark"})')
...
appelm.className = "app"
appelm.id = apps[app].id
appelm.setAttribute("onclick", 'new Noir({"id":' + apps[order[app]].id + ', "title": "' + apps[order[app]].title + '", "type": "' + apps[app].type + '", "' + apps[app].type + '": "' + apps[order[app]][apps[app].type] + '", "width": 800, "height": 600})')
